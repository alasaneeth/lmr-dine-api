...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.bulkInsert('users', [
      { name: 'Kavindu Dilshan', email: 'admin@resto.lk',    password_hash:'$2b$10$G4ZfUe3CS8pHrvAqDMUyOOR/t8z4TsZoorD29KPPRY/OXng6BWhtW', role: 'admin',    status: 'active',   mfa_enabled: false, created_at: now, updated_at: now },
      { name: 'Nimal Perera',    email: 'waiter@resto.lk',   password_hash:'$2b$10$G4ZfUe3CS8pHrvAqDMUyOOR/t8z4TsZoorD29KPPRY/OXng6BWhtW', role: 'waiter',   status: 'active',   mfa_enabled: false, created_at: now, updated_at: now },
      { name: 'Samitha Bandara', email: 'cashier@resto.lk',  password_hash:'$2b$10$G4ZfUe3CS8pHrvAqDMUyOOR/t8z4TsZoorD29KPPRY/OXng6BWhtW', role: 'cashier',  status: 'active',   mfa_enabled: false, created_at: now, updated_at: now },
      { name: 'Dilini Fernando', email: 'customer@resto.lk', password_hash:'$2b$10$G4ZfUe3CS8pHrvAqDMUyOOR/t8z4TsZoorD29KPPRY/OXng6BWhtW', role: 'customer', status: 'active',   mfa_enabled: false, created_at: now, updated_at: now },
      { name: 'Ruwan Mendis',    email: 'ruwan@resto.lk',    password_hash:'$2b$10$G4ZfUe3CS8pHrvAqDMUyOOR/t8z4TsZoorD29KPPRY/OXng6BWhtW', role: 'waiter',   status: 'inactive', mfa_enabled: false, created_at: now, updated_at: now },
      { name: 'Amal Perera',     email: 'amal@resto.lk',     password_hash:'$2b$10$G4ZfUe3CS8pHrvAqDMUyOOR/t8z4TsZoorD29KPPRY/OXng6BWhtW', role: 'customer', status: 'active',   mfa_enabled: false, created_at: now, updated_at: now },
  ...
  async down(queryInterface) {
    await queryInterface.bulkDelete('customers',   null, { truncate: true });
    await queryInterface.bulkDelete('stock_items', null, { truncate: true });
    await queryInterface.bulkDelete('menu_items',  null, { truncate: true });
